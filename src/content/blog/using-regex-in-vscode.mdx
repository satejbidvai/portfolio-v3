...
draft: false
ogImage: '/og/using-regex-in-vscode.png'
---
...
Let's take a look at how we can leverage regex to:
...
#### Here's what we can do:
    ...
    2. **Use AI to quickly generate a regex** - <InlineCode pattern="className=\{`[^`]*-\$\{" /><br/>
       _Apologies to all the 10x devs, sorry, it's hard to remember the syntax_
...
![Search for dynamic classes](images/using-regex-in-vscode/search-for-dynamic-classes.png)
